...
return [
    ...
    'description' => 'Exchange Rate API provides access to currency exchange rates fetched from the European Central Bank (ECB).',
    ...
    'routes' => [
        [
            ...
            'include' => [
                'exchange-rates.index', 'exchange-rates.show'
            ],
    ...
    'auth' => [
        ...
        'placeholder' => '1|YOUR_SANCTUM_TOKEN',

        // Any extra authentication-related info for your users. Markdown and HTML are supported.
        'extra_info' => 'You can obtain a token by running `php artisan db:seed` which creates a test user and displays the token, or by using Laravel Tinker to create a token for an existing user.',
    ],
